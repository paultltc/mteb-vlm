...
from transformers.models.qwen2_5_vl.configuration_qwen2_5_vl import Qwen2_5_VLConfig as _Qwen2_5_VLConfig
...
class Qwen2_5_VLConfig(_Qwen2_5_VLConfig):
    def __init__(self, fused_linear_ce=False, **kwargs):
    ...
    def _prepare_4d_causal_attention_mask_with_cache_position(
        ...
        if attention_mask is not None and attention_mask.dim() == 4:
            ...
            causal_mask = torch.full(
                (sequence_length, target_length), fill_value=0, dtype=dtype, device=device
            )
